# Textübersicht aller Seiten

Hinweis: Navigation, Footer und Cookie-Consent werden teilweise per JavaScript gerendert. Diese wiederkehrenden Texte stehen daher einmal gesammelt am Anfang. Danach folgt der seitenindividuelle Hauptinhalt pro HTML-Seite.
...
### Mobile Sticky CTA (auf Seiten mit aktiviertem Mobile-CTA)
...
- Auswahl speichern
- Alle akzeptieren
- Panel-Zusatz: Deine Auswahl für Statistik und Marketing
- Panel-Zusatz: Notwendige Cookies
- Panel-Zusatz: Diese Cookies sind für den Betrieb der Website erforderlich und speichern z. B. deine Consent-Auswahl.
...
- Panel-Zusatz: Diese Cookies können verwendet werden, um Besuchern relevante Werbung anzuzeigen.
- Panel-Zusatz: Marketing aktivieren

## ablauf.html

- Seitentitel: Ablauf | Smart Web Studio
...
- Einordnung: Einstieg / Intro | Fokus: Ein klar geführter Prozess schafft Vertrauen, Tempo und bessere Entscheidungen. | Kontext: Ablauf
- ID: keine
...
- Einordnung: Prozess / Vorgehen | Fokus: Von der Analyse bis zur Optimierung mit sauberer Reihenfolge. | Kontext: Sechs Schritte
- ID: keine
...
- Einordnung: Pakete / Inhalte | Fokus: Was der Ablauf für die Zusammenarbeit spürbar besser macht. | Kontext: Vertrauensbausteine
- ID: keine
...
- Einordnung: Abschluss / CTA | Fokus: Wenn du einen klaren Projektprozess willst.
- ID: keine
...
- Seitentitel: Branding | Smart Web Studio
...
- Einordnung: Einstieg / Intro | Fokus: Klarheit in Botschaft und Auftritt macht aus Vergleichbarkeit eine bessere Wahl. | Kontext: Branding & Positionierung
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Prozess / Vorgehen | Fokus: Marke als System, nicht als lose Design-Entscheidung. | Kontext: Ansatz
- ID: approach
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Ansatz
...
- Einordnung: Ergebnisse / Deliverables | Fokus: Was du im Ergebnis in der Hand hast. | Kontext: Lieferumfang
- ID: deliverables
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Lieferumfang
...
- Einordnung: Standards / Qualitätsrahmen | Fokus: Branding soll nicht dekorieren. Es soll Klarheit und Wert spürbar machen. | Kontext: Philosophie & Qualität
- ID: standards
...
- Einordnung: Verwandte Leistungen / nächste Schritte | Fokus: Branding wirkt am stärksten, wenn Website und Nachfrage
danach sauber anschließen. | Kontext: Passende nächste Schritte
- ID: related
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Abschluss / CTA | Fokus: Wenn deine Marke hochwertiger, klarer und glaubwürdiger wirken soll.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Case Study | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 5

### Section 1: Beispielhafte Projektstruktur statt erfundener Referenz.
- Einordnung: Einstieg / Intro | Fokus: Beispielhafte Projektstruktur statt erfundener Referenz. | Kontext: Case Study
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Case Study
...
- Einordnung: Prozess / Vorgehen | Fokus: Ausgangslage | Kontext: 01
- ID: keine
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
01
...
- Einordnung: Einordnung / Kontext | Fokus: Die Wirkung zeigt sich hier in Klarheit, Führung und Wahrnehmung. | Kontext: Qualitative Ergebnisse
- ID: keine
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Pakete / Inhalte | Fokus: Vom Projektbeweis direkt in Leistung, Ablauf oder Erstgespräch. | Kontext: Weiterführende Wege
- ID: keine
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Weiterführende Wege
...
- Einordnung: Abschluss / CTA | Fokus: Wenn du dieselbe Klarheit in deinem Projekt sehen willst.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Cookie-Einstellungen | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 6

### Section 1: Cookies, Consent und deine Auswahl
- Einordnung: Rechtlicher Einstieg | Fokus: Cookies, Consent und deine Auswahl | Kontext: Cookie-Einstellungen
- ID: keine
- CSS-Klasse: legal-hero reveal-on-scroll
```text
Cookie-Einstellungen
...
funktioniert
- Einordnung: Fokus: Wie Consent auf dieser Website
funktioniert
- ID: keine
- CSS-Klasse: legal-section reveal-on-scroll
```text
...
Die Consent-Auswahl kann jederzeit über den Footer-Link Cookie-Einstellungen
oder über den
Button auf dieser Seite erneut geöffnet und angepasst werden.
```

### Section 3: Notwendige Cookies
- Einordnung: Fokus: Notwendige Cookies
- ID: keine
- CSS-Klasse: legal-section reveal-on-scroll
```text
Notwendige Cookies
...
- Einordnung: Fokus: Statistik Cookies
- ID: keine
- CSS-Klasse: legal-section reveal-on-scroll
```text
Statistik Cookies
...
- Einordnung: Fokus: Marketing Cookies
- ID: keine
- CSS-Klasse: legal-section reveal-on-scroll
```text
Marketing Cookies
...
- Einordnung: Cookie-Einstellungen | Fokus: Cookie-Einstellungen ändern
- ID: cookie-settings
- CSS-Klasse: legal-section reveal-on-scroll
```text
...
- Seitentitel: Danke | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 4

### Section 1: Deine Anfrage ist angekommen.
- Einordnung: Einstieg / Intro | Fokus: Deine Anfrage ist angekommen. | Kontext: Bestätigung
- ID: keine
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Bestätigung
...
weiter.
- Einordnung: Prozess / Vorgehen | Fokus: So geht es ab hier sinnvoll
weiter. | Kontext: Nächste Schritte
- ID: keine
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Nächste Schritte
...
- Einordnung: Pakete / Inhalte | Fokus: Wenn du dich bis zur Rückmeldung
weiter orientieren willst. | Kontext: Währenddessen sinnvoll
- ID: keine
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
willst.
- Einordnung: Abschluss / CTA | Fokus: Wenn du parallel schon den nächsten Schritt fixieren
willst.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Datenschutz | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 10

### Section 1: Datenschutzerklärung
- Einordnung: Rechtlicher Einstieg | Fokus: Datenschutzerklärung | Kontext: Rechtliches
- ID: keine
- CSS-Klasse: legal-hero reveal-on-scroll
```text
Rechtliches
...
- Einordnung: Fokus: Verantwortlicher
- ID: verantwortlicher
- CSS-Klasse: legal-section reveal-on-scroll
```text
Verantwortlicher
...
- Einordnung: Fokus: Zwecke der Verarbeitung
- ID: zwecke
- CSS-Klasse: legal-section reveal-on-scroll
```text
...
- Einordnung: Fokus: Rechtsgrundlagen
- ID: rechtsgrundlagen
- CSS-Klasse: legal-section reveal-on-scroll
```text
Rechtsgrundlagen
...
- Einordnung: Fokus: Cookies & Consent
- ID: cookies-consent
- CSS-Klasse: legal-section reveal-on-scroll
```text
Cookies & Consent
...
- Einordnung: Fokus: Empfänger / Auftragsverarbeiter
- ID: empfaenger
- CSS-Klasse: legal-section reveal-on-scroll
```text
...
- Einordnung: Fokus: Speicherdauer
- ID: speicherdauer
- CSS-Klasse: legal-section reveal-on-scroll
```text
Speicherdauer
...
- Einordnung: Fokus: Betroffenenrechte
- ID: rechte
- CSS-Klasse: legal-section reveal-on-scroll
```text
Betroffenenrechte
...
- Einordnung: Fokus: Drittlandtransfer
...
- Einordnung: Fokus: Kontakt Datenschutz
...
- Seitentitel: Growth Strategie | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 7

### Section 1: Growth wird erst dann sinnvoll, wenn Angebot, Website und Tracking stabil genug sind.
- Einordnung: Einstieg / Intro | Fokus: Growth wird erst dann sinnvoll, wenn Angebot, Website und Tracking stabil genug sind. | Kontext: Growth Strategie
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Growth Strategie
...
hat.
- Einordnung: Prozess / Vorgehen | Fokus: Growth beginnt mit der Frage, was zuerst den größten Hebel
hat. | Kontext: Ansatz
- ID: approach
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Ergebnisse / Deliverables | Fokus: Was du konkret für Priorisierung, Optimierung und
Wachstumssystem bekommst. | Kontext: Lieferumfang
- ID: deliverables
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Lieferumfang
...
Lernschleifen.
- Einordnung: Standards / Qualitätsrahmen | Fokus: Kein Growth-Theater ohne Fundament, Tracking und echte
Lernschleifen. | Kontext: Standards
- ID: standards
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Standards
...
- Einordnung: Verwandte Leistungen / nächste Schritte | Fokus: Growth funktioniert am besten auf einem klaren technischen
und inhaltlichen Fundament. | Kontext: Passende nächste Schritte
- ID: related
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Passende nächste Schritte
...
- Einordnung: Abschluss / CTA | Fokus: Wenn Wachstum systematisch statt zufällig werden soll.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Impressum | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 6

### Section 1: Impressum / Anbieterkennzeichnung
- Einordnung: Rechtlicher Einstieg | Fokus: Impressum / Anbieterkennzeichnung | Kontext: Rechtliches
- ID: keine
- CSS-Klasse: legal-hero reveal-on-scroll
```text
Rechtliches
...
- Einordnung: Fokus: Vertretungsberechtigte Person
...
- Einordnung: Fokus: Register / UID / Unternehmensdaten
- ID: register-uid
- CSS-Klasse: legal-section reveal-on-scroll
```text
...
- Einordnung: Fokus: Haftung / Links
- ID: haftung-links
- CSS-Klasse: legal-section reveal-on-scroll
```text
Haftung / Links
...
- Seitentitel: Smart Web Studio | High-End Websites mit Struktur und Conversion
- Anzahl top-level Sections im Hauptinhalt: 8

### Section 1: High-End Websites
mit
Klarheit.
...
mit
System.
- Einordnung: Hero / Einstieg | Fokus: High-End Websites
mit
Klarheit.
...
Conversion
mit
System. | Kontext: Strategie, Design und Umsetzung aus einer Hand
- ID: hero-stage
- CSS-Klasse: hero-stage hero-stage--full-bleed animate-enter
```text
...
- Einordnung: Fokus: Vertrauensargumente | Kontext: Klarheit
- ID: keine
- CSS-Klasse: trust-strip scroll-focus-section mt-10 lg:mt-14 px-0
```text
Vertrauensargumente
...
- Einordnung: Problem | Fokus: Viele Websites sehen hochwertig aus und verlieren trotzdem Anfragen. | Kontext: Problem
- ID: problem
- CSS-Klasse: approach-section scroll-focus-section animate-enter delay-200 mt-16 lg:mt-20 px-0
```text
Problem
...
- Einordnung: Leistungsübersicht | Fokus: Drei Kernhebel für einen Auftritt, der nicht nur gut aussieht. | Kontext: Leistungen
- ID: services
- CSS-Klasse: service-pillars-section scroll-focus-section animate-enter delay-300 mt-10 lg:mt-16 relative w-full
```text
Leistungen
...
- Einordnung: Projektbeispiel | Fokus: Ein Projektbeweis, der auf Struktur statt auf Showeffekte setzt. | Kontext: Projekt-Teaser
- ID: featured-project
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Projekt-Teaser
...
- Einordnung: Prozess / Vorgehen | Fokus: Ein professioneller Prozess statt kreativer Black Box. | Kontext: Ablauf
- ID: process
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Ablauf
...
- Einordnung: Pakete / Inhalte | Fokus: Jeder Besucher sollte sofort wissen, wie es für ihn weitergeht. | Kontext: Zwei klare Wege
- ID: conversion-paths
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Zwei klare Wege
...
- Einordnung: Abschluss / CTA | Fokus: Wenn dein Auftritt hochwertiger, klarer und wirksamer werden soll.
- ID: kontakt
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Insights | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 4

### Section 1: Ein Themenbereich für hochwertige
Websites, starke Marken und klarere Nachfrage.
- Einordnung: Einstieg / Intro | Fokus: Ein Themenbereich für hochwertige
Websites, starke Marken und klarere Nachfrage. | Kontext: Insights
- ID: keine
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Insights
...
- Einordnung: Fokus: Die häufigsten Hebel, an denen
hochwertige Projekte gewinnen oder scheitern. | Kontext: Themencluster
- ID: keine
- CSS-Klasse: insight-cluster-section py-16 lg:py-24 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Themencluster
...
ohne Umweg.
- Einordnung: Pakete / Inhalte | Fokus: Von Insight zu passender Leistung
ohne Umweg. | Kontext: Direkter Transfer
- ID: keine
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Direkter Transfer
...
willst.
- Einordnung: Abschluss / CTA | Fokus: Wenn du ein Thema direkt auf dein Projekt übertragen
willst.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Einstieg / Intro | Fokus: Zwei klare Wege in den Projektstart. | Kontext: Kontakt
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Kontakt
...
- Einordnung: Terminbuchung / Einstiege | Fokus: Erstgespräch oder Projektformular. Klar statt kompliziert. | Kontext: Einstiege
- ID: terminbuchung
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Einstiege
...
- Einordnung: Kontaktformular | Fokus: Projektanfrage senden | Kontext: Zusammenarbeit
- ID: kontaktformular
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
E-Mail ist verpflichtend. Projektart, Zeitrahmen und kurze Ausgangslage helfen bei der schnelleren
Einordnung.
...
- Seitentitel: Weiterleitung | Smart Web Studio
- Struktur: Kein eigener `<section>`-Block im `<main>`, daher als ein Inhaltsblock erfasst.

### Hauptinhalt
- Kurzbeschreibung: Ein einzelner Inhaltsblock ohne Unterteilung.
```text
Die Seite wurde verschoben.

Du wirst automatisch zu SEO & Marketing
weitergeleitet.
...
- Seitentitel: Preise | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 4

### Section 1: Drei Pakete für unterschiedliche Reifegrade, aber mit derselben Qualitätslogik.
- Einordnung: Einstieg / Intro | Fokus: Drei Pakete für unterschiedliche Reifegrade, aber mit derselben Qualitätslogik. | Kontext: Preise
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Preise
...
- Einordnung: Pakete / Inhalte | Fokus: Preispakete | Kontext: Starter
- ID: keine
- CSS-Klasse: packages-section py-0 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Preispakete
...
- Einordnung: Einordnung / Kontext | Fokus: Unsicher, welches Paket wirklich passt? | Kontext: Orientierung
- ID: keine
- CSS-Klasse: about-section about-section--next-steps py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Orientierung
...
- Einordnung: Abschluss / CTA | Fokus: Wenn du den passenden Scope sauber einordnen willst.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Einordnung: Pakete / Inhalte | Fokus: Vier typische Projektarten mit klarer Maßnahme und nachvollziehbarer Wirkung. | Kontext: Projektmuster
- ID: keine
- CSS-Klasse: packages-section project-grid-section py-16 lg:py-24 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Projektmuster
...
Ausgangslage:
Das Angebot war stark, aber im Markt zu breit und
visuell uneinheitlich dargestellt.

Maßnahme:
Positionierung schärfen, Website neu strukturieren,
Kontaktwege priorisieren und Design konsistent übersetzen.

Ergebnis:
Klarerer Premium-Eindruck, bessere Nutzerführung und
...
Ausgangslage:
Die Website hatte Inhalte, aber keine klare
Seitenlogik für Zielgruppen, Suchintention und Kontakt.

Maßnahme:
Zielseiten priorisieren, interne Verlinkung anpassen,
Headings und CTA-Wege sauber aufeinander ausrichten.

Ergebnis:
Bessere Orientierung, stärkere thematische Klarheit und
...
Ausgangslage:
Es gab einzelne Marketing-Maßnahmen, aber keine
belastbare Reihenfolge zwischen Themen, Zielseiten und Messpunkten.

Maßnahme:
Themencluster priorisieren, Conversion-Events definieren
und Optimierungs-Backlog nach Wirkung sortieren.

Ergebnis:
Klarere Entscheidungsgrundlagen, bessere Priorisierung
...
Ausgangslage:
Die Nachfrage war vorhanden, doch Angebot,
Kontaktformular und CTA-Logik erzeugten unnötige Reibung.

Maßnahme:
Funnel-Landkarte aufbauen, Kontaktwege entlasten,
Conversion-Hürden reduzieren und Hypothesen priorisieren.

Ergebnis:
Weniger Reibung im Weg zur Anfrage und ein besser
...
- Seitentitel: SEO & Marketing | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 7

### Section 1: Sichtbarkeit ist erst dann wertvoll, wenn sie in die richtige Anfrage führt.
- Einordnung: Einstieg / Intro | Fokus: Sichtbarkeit ist erst dann wertvoll, wenn sie in die richtige Anfrage führt. | Kontext: SEO & Marketing
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
SEO & Marketing
...
- Einordnung: Prozess / Vorgehen | Fokus: Sichtbarkeit wird entlang echter Nutzerfragen und Angebotsziele geplant. | Kontext: Ansatz
- ID: approach
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Ansatz
...
- Einordnung: Ergebnisse / Deliverables | Fokus: Was du im Ergebnis für Sichtbarkeit, Inhalte und Messbarkeit bekommst. | Kontext: Lieferumfang
- ID: deliverables
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Lieferumfang
...
- Einordnung: Standards / Qualitätsrahmen | Fokus: Kein Vanity-Traffic. Keine Reports ohne Konsequenz. | Kontext: Standards
- ID: standards
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Standards
...
klaren Fundament.
- Einordnung: Verwandte Leistungen / nächste Schritte | Fokus: SEO & Marketing funktionieren am stärksten auf einem
klaren Fundament. | Kontext: Passende nächste Schritte
- ID: related
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Passende nächste Schritte
...
- Einordnung: Abschluss / CTA | Fokus: Wenn Sichtbarkeit sauber in qualifizierte Anfragen übersetzen soll.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Social Strategie | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 7

### Section 1: Social Content braucht Richtung, System und einen klaren Weg ins Angebot.
- Einordnung: Einstieg / Intro | Fokus: Social Content braucht Richtung, System und einen klaren Weg ins Angebot. | Kontext: Social Strategie
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Social Strategie
...
- Einordnung: Prozess / Vorgehen | Fokus: Social wird aus Positionierung und Angebotslogik gedacht. | Kontext: Ansatz
- ID: approach
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Ansatz
...
- Einordnung: Ergebnisse / Deliverables | Fokus: Was du konkret für Social, Content und Übergänge bekommst. | Kontext: Lieferumfang
- ID: deliverables
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Lieferumfang
...
klingen.
- Einordnung: Standards / Qualitätsrahmen | Fokus: Social muss machbar sein, nicht nur strategisch gut
klingen. | Kontext: Standards
- ID: standards
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Standards
...
- Einordnung: Verwandte Leistungen / nächste Schritte | Fokus: Social Strategie wird stärker, wenn Marke, Website und
Growth sauber anschließen. | Kontext: Passende nächste Schritte
- ID: related
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Passende nächste Schritte
...
- Einordnung: Abschluss / CTA | Fokus: Wenn Social nicht nur präsent, sondern wirksam sein soll.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Über mich | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 5

### Section 1: Du arbeitest direkt mit mir.
- Einordnung: Einstieg / Intro | Fokus: Du arbeitest direkt mit mir. | Kontext: Über mich
- ID: keine
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Über mich
...
- Einordnung: Pakete / Inhalte | Fokus: Warum Smart Web Studio bewusst anders arbeitet als klassische Agentur-Setups. | Kontext: Zusammenarbeit
- ID: keine
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Zusammenarbeit
...
- Einordnung: Einordnung / Kontext | Fokus: Hochwertig heißt für mich: schön, nachvollziehbar und wirksam. | Kontext: Qualitätsanspruch
- ID: keine
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Qualitätsanspruch
...
willst.
- Einordnung: Abschluss / CTA | Fokus: Wenn du direkte Zusammenarbeit und klare Entscheidungen
willst.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
...
- Seitentitel: Webentwicklung | Smart Web Studio
- Anzahl top-level Sections im Hauptinhalt: 7

### Section 1: Websites mit Struktur, Klarheit und einer Conversion-Logik, die zum Angebot passt.
- Einordnung: Einstieg / Intro | Fokus: Websites mit Struktur, Klarheit und einer Conversion-Logik, die zum Angebot passt. | Kontext: Webentwicklung
- ID: keine
- CSS-Klasse: py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Webentwicklung
...
- Einordnung: Prozess / Vorgehen | Fokus: Strategie vor Oberfläche. Seitenarchitektur vor Code. | Kontext: Ansatz
- ID: approach
- CSS-Klasse: process-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Ansatz
...
- Einordnung: Ergebnisse / Deliverables | Fokus: Was du konkret bekommst und was es im Ergebnis verbessert. | Kontext: Lieferumfang
- ID: deliverables
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Lieferumfang
...
- Einordnung: Standards / Qualitätsrahmen | Fokus: Performance ist kein Extra. Sie ist Teil des Standards. | Kontext: Qualitätsstandards
- ID: standards
- CSS-Klasse: about-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Qualitätsstandards
...
- Einordnung: Verwandte Leistungen / nächste Schritte | Fokus: Webentwicklung wirkt am stärksten im Zusammenspiel mit den
richtigen Nachbarleistungen. | Kontext: Passende nächste Schritte
- ID: related
- CSS-Klasse: packages-section py-24 lg:py-32 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
Passende nächste Schritte
...
- Einordnung: Abschluss / CTA | Fokus: Wenn deine Website nicht nur Eindruck, sondern Anfragen erzeugen soll.
- ID: keine
- CSS-Klasse: final-cta-section py-32 lg:py-40 px-4 sm:px-6 lg:px-8 scroll-focus-section
```text
