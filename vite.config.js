  ...
  build: {
    rollupOptions: {
      input: {
        ...
        projektWebsiteBranding: resolve(__dirname, "projekte/website-branding-setup.html"),
        projektRelaunchSeo: resolve(__dirname, "projekte/relaunch-seo.html"),
        projektContentTracking: resolve(__dirname, "projekte/content-tracking-system.html"),
        projektFunnelOptimierung: resolve(__dirname, "projekte/funnel-optimierung.html"),
      },
    },
  },
});
